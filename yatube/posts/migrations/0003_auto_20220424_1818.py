# Generated by Django 2.2.16 on 2022-04-24 18:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0002_auto_20220308_1544'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='group',
            options={'verbose_name': 'Social group', 'verbose_name_plural': 'Social groups'},
        ),
        migrations.AlterModelOptions(
            name='post',
            options={'ordering': ('-pub_date',), 'verbose_name': 'Text post', 'verbose_name_plural': 'Text posts'},
        ),
